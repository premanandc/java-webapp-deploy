...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "oclc-tw-test-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/oclc-tw-test"
  #   chef.validation_client_name = "oclc-tw-test-validator"
  #   chef.validation_key_path = ".chef/oclc-tw-test-validator.pem"
  # end
end
